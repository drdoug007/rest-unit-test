...
- **Spring Security Integration**: Secured API endpoints with Basic Auth and Form Login. Public access allowed for viewing tests, while execution of custom tests requires authentication.
